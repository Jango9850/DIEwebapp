      ...
      <div id="entries">
        ...
        <div v-for="entry in entries" :key="entry.id" class="entry">
          ...
          <div class="entry-info">
            ...
            <p><i class="fas fa-clock"></i> Availability: {{ entry.availability }}</p>
  
            <p><i class="fas fa-money-bill"></i> Cost: {{ entry.cost }} EUR / month</p>
  
            <p><i class="fas fa-map-marker-alt"></i> Address: {{ entry.address }}</p>
      ...
      <div v-if="showModal" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="form-info">
            ...
            <p>Share your flat during the semester breaks and help a fellow student!</p>
          ...
          <form @submit.prevent="addEntry">
            ...
            <input type="url" id="flatImage" placeholder="Picture URL" v-model="newEntry.imageUrl" required>
  
            <label for="availability">Availability:</label>
  
            <input type="text" id="availability" placeholder="From - To" v-model="newEntry.availability" required>
  
            <label for="cost">Cost:</label>
  
            <input type="number" id="cost" placeholder="Enter monthly cost in EUR" v-model="newEntry.cost" required>
  
            <label for="address">Address:</label>
  
            <input type="text" id="address" placeholder="Enter address" v-model="newEntry.address" required>
